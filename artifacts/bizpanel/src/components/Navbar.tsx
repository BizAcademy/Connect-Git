...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/30">
      <div className="container mx-auto flex items-center justify-between h-16 px-4 sm:px-6">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div ref={dropdownRef} className="relative">
            ...
            >
              Services <ChevronDown size={14} className={`transition-transform duration-150 ${servicesOpen ? "rotate-180" : ""}`} />
            </button>

            <div
              className={`absolute top-full left-1/2 -translate-x-1/2 mt-3 bg-white rounded-2xl shadow-xl border border-border/30 overflow-hidden transition-all duration-150 ${
                servicesOpen
      ...
      {/* Mobile menu */}
      <div
        className={`md:hidden bg-background border-b border-border/40 overflow-hidden transition-all duration-200 ${
        ...
        <div className="flex flex-col gap-1 p-4">
          ...
          <div
            className={`overflow-hidden transition-all duration-200 ${
              servicesOpen ? "max-h-[50vh]" : "max-h-0"
            }`}
          >
