      ...
      <div className="container px-4 md:px-6">
        <div className="text-center mb-6 md:mb-16">
          <h2 className="font-heading font-black text-lg md:text-4xl mb-2 md:mb-4 text-foreground">
            Rechargez votre{" "}
            <span style={{ color: "hsl(25, 95%, 53%)" }}>compte</span>
          </h2>
          <p className="text-muted-foreground text-xs md:text-lg max-w-2xl mx-auto">
            Choisissez un montant de recharge pour démarrer vos commandes.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 max-w-5xl mx-auto">
          {plans.map((plan) => (
            ...
            >
              {plan.popular && (
                <div
                  className="absolute -top-3 md:-top-4 left-1/2 -translate-x-1/2 px-3 md:px-5 py-1 md:py-1.5 rounded-full text-[10px] md:text-xs font-black uppercase tracking-wide text-white"
