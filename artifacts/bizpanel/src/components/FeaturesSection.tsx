...
const features = [
  ...
  },
  {
    ...
    description: "Orange, MTN, Wave, Moov, Airtel — paiement depuis votre téléphone.",
    color: "#4CAF50",
    bg: "#E8F5E9",
  },
  {
    ...
    description: "Recharge automatique si les chiffres baissent après livraison.",
    color: "#FF5722",
    bg: "#FBE9E7",
  },
  {
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-2.5 md:gap-6">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="flex flex-col md:flex-row md:items-start gap-2 md:gap-4 p-3 md:p-6 rounded-xl md:rounded-2xl border border-border/40 hover:border-primary/30 hover:shadow-md transition-shadow bg-white group"
            >
              <div
                className="shrink-0 w-8 h-8 md:w-12 md:h-12 rounded-xl md:rounded-2xl flex items-center justify-center"
